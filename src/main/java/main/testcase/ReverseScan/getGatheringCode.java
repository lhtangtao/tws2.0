 ...
 */
public class getGatheringCode {
    String testUrl = "/api/shop/qrcode";
    @DataProvider(name = "ex")
    public static Object[][] words() throws IOException {
        InputStream in = readexcel.class.getClassLoader().getResourceAsStream("fansao.xls");
        Object[][] result = gettestdata(in, "ggc");
        return result;
    }
    @BeforeClass
    ...
    public void getAuthCode_code(String type,String exres,String excode){
        if(type.equals("空")){
            type="";
        }
        String url=url_to_start()+"?type="+type+url_base();
