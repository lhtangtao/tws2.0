...
import static main.unit.del_qrcode.delQrcode;
...
/**
 * Created by tangtao on 2016/5/25.
 */
public class activeThecode {
    private String testUrl = "/api/shop/qrcode";
    ...
    public static Object[][] words() throws IOException {
        ...
        Object[][] result = gettestdata(in, "active");
        return result;
    }

    @Test(dataProvider = "ex")
    public void active(String shopid, String qrCode, String exres, String excode, String exmessage)
        ...
        jsonParam.put("qrCode", qrCode);//添加json内容
