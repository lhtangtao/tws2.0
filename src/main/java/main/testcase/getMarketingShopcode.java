 ...
 */
public class getMarketingShopcode {
    String testUrl = "/api/expansion/shopCode";
    ...
    public static Object[][] words() throws IOException {
        ...
        Object[][] result = gettestdata(in, "getMarketingShopcode");
        return result;
    }
    @BeforeClass
    ...
    public void getMarketingInfo(String shopcode,String exdata,String excode,String exres){
