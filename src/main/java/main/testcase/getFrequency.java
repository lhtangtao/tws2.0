...
public class getFrequency {
    String testUrl = "/api/activity/count";
    ...
    public static Object[][] words() throws IOException {
        ...
        Object[][] result = gettestdata(in, "getFrequency");
        return result;
    }
    @BeforeClass
    ...
    public void getFrequency(String activityType,String  exdata,String excode,String exres) throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
