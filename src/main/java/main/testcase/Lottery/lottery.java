...
public class lottery {
    private String testUrl = "/api/shop/lottery";
    ...
    public static Object[][] words() throws IOException {
        ...
        Object[][] result = gettestdata(in, "lottery");
        return result;
    }
    @Test(dataProvider = "ex")
    public void lottery(String shopid,String exres, String excode, String exmessage) throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException, IOException {
