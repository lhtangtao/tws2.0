package main.testcase.CashCliiection;
 ...
 */
public class cashCliiection {
    private String testUrl = "/api/shop/order/cashment";
    ...
    public static Object[][] words() throws IOException {
        InputStream in = readexcel.class.getClassLoader().getResourceAsStream("xianjin.xls");
        Object[][] result = gettestdata(in, "cashCollection");
        return result;
    }
    @Test(dataProvider = "ex")
    public void cashcollection(String amount,String exres,String excode,String exmessage) throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException, IOException {
