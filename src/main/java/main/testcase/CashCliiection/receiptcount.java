...
public class receiptcount {
    private String testUrl = "/api/shop/order/receiptcount";
    ...
    public static Object[][] words() throws IOException {
        ...
        Object[][] result = gettestdata(in, "receiptcount");
        return result;
    }
    @Test(dataProvider = "ex")
    public void receiptcount(String date,String shopId,String exres, String excode, String exmessage) throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException, IOException {
