...
public class orderDelete {
    String testUrl = "/api/shop/order/orderdelete";
    ...
    public static Object[][] words() throws IOException {
        ...
        Object[][] result = gettestdata(in, "orderdelete");
        return result;
    }
    @BeforeClass
    ...
    public void orderdelete(String orderNo,String exres,String excode){
        if (orderNo.equals("空")) {
            orderNo= "";
        }
        String url=url_to_start()+"?mobilePhone="+orderNo+url_base();
