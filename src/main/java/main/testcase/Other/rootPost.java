...
public class rootPost {
    private String testUrl ="/api/ucenter/auth";
    ...
    public static Object[][] words() throws IOException {
        ...
        Object[][] result = gettestdata(in, "rootpost");
        return result;
    }

    @Test(dataProvider = "ex")
    public void login_result(String employeeId,String exres, String excode, String exmessage) throws IOException, ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
