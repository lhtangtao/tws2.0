...
public class direction {
    String testUrl = "/api/integral/mall/direction";
    ...
    public static Object[][] words() throws IOException {
        ...
        Object[][] result = gettestdata(in, "direction");
        return result;
    }
    @BeforeClass
    ...
    public void direction(String systemId,String openId,String platformType,String signature,String exres,String excode){
