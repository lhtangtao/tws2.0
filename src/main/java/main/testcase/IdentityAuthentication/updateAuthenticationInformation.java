 ...
 */
public class updateAuthenticationInformation {
    ...
    public static Object[][] words() throws IOException {
        ...
        Object[][] result = gettestdata(in, "uai");
        return result;
    }
    @Test(dataProvider = "ex")
    public void uai_result(String sessionGuid,String shopId,String userName,String idNo,String Businesslicense,String frontalImage,String backImage,String handHoldingImage,
                           String exres, String excode, String exmessage)
